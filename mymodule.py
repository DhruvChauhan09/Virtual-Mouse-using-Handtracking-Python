    ...
    def findPosition(self, img, handNo=0, draw=True):
        ...
        if self.results.multi_hand_landmarks: 
            ...
            for id,lm in enumerate(myHand.landmark):
                ...
                if draw:
                    cv2.circle(img, (cx,cy), 12, (100,200,100), cv2.FILLED)
...
def main():
    ...
    while True:
        ...
        cv2.putText(img, str(float(fps)), (10,70), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (144,12,144), 3) 
                        #                     position          font            scale      color    thick 
